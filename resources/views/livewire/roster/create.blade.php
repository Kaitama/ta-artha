<div class="pb-10">
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight mt-2">
                <a class="text-blue-600" href="{{ route('rosters.index') }}">Roster</a> / Buat baru
            </h2>
        </div>
    </x-slot>
    ...
    <div class="sm:mx-4">
        <x-form-section submit="store">
            ...
            <x-slot name="description">Semester ganjil dimulai dari bulan Juli sampai Desember. <br>Semester genap dimulai dari bulan Januari sampai Juni.</x-slot>
