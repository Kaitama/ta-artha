                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                            <div class="flex items-center px-0 md:px-2 text-sm text-gray-500 border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition cursor-pointer hover:text-gray-600">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('logout') }}" x-data>
                            ...
                            <x-dropdown-link class="flex items-center gap-2" href="{{ route('logout') }}" @click.prevent="$root.submit();">
                                <svg class="w-4 h-4 text-gray-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16">
